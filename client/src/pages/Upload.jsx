      ...
      {currentUser ? (
        <div>
          ...
          <div className="flex flex-col sm:flex-row  mt-5 gap-9">
            <div
              id="left"
              className="w-[50%] h-[430px] flex flex-col items-center justify-center gap-5 border border-lightText border-dashed"
            >
            ...
            <div id="right" className="w-[50%]">
              ...
              <div className="w-full border border-lightText p-3 my-5">
                ...
                <input onChange={handleChange} type="file" id="thumbnailUrl" />
              </div>
              <div className="w-full border border-lightText p-3 my-5">
                <p>Title:</p>
                <input
        ...
        <div className="w-full h-[80vh] flex items-center justify-center">
          <h1 className="text-center">
            you can't access this page. <br /> Firstly do login
          </h1>
        </div>
      )}
