...
function Register() {
  ...
  const handleSubmit = async(e) =>{
    ...
    try {
      const res =  await fetch('http://localhost:6060/api/v1/user/auth/register',{
        method: 'POST',
        headers:{
  ...
  return (
    <div className=' max-w-lg mx-auto p-3 w-full py-16'>
        ...
        <form onSubmit={handleSubmit} className='flex flex-col gap-3 w-[80%]'>
            <input type="text" onChange={handleChange} id='userName' placeholder='username' className='bg-slate-200 p-2 rounded-lg border' />
        ...
        <p className='bg-red-700 p-2 rounded-lg border text-white text-center mt-3 font-semibold w-[80%]'>SIGN IN USING GOOGLE</p>
